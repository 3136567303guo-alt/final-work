# 过程文档：从有序到混沌的涌现
## 1. 理论选型与算法构建 
在流体力学中，Navier-Stokes方程通常被视为绝对真理。然而，本项目放弃了直接求解偏微分方程的传统路径，转而采用格子玻尔兹曼方法。我构建了一个由数万个微观粒子组成的虚拟风洞，通过简单的局部碰撞与迁移规则，在宏观上成功还原了复杂的非线性流体现象——卡门涡街。
...
*   **交互记录**：
    > **我的提问**：我是物理系学生，差不多可以勉强理解 LBM 的数学推导，但 Python 的循环太慢了。如何利用 NumPy 的矩阵特性来实现 $f_i(\mathbf{x} + \mathbf{c}_i \Delta t) = f_i(\mathbf{x})$ 这一迁移步骤？
    >
